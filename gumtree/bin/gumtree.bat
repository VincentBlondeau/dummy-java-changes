...
set CLASSPATH=%APP_HOME%\lib\dist-2.1.0-SNAPSHOT.jar;%APP_HOME%\lib\core-2.1.0-SNAPSHOT.jar;%APP_HOME%\lib\client-2.1.0-SNAPSHOT.jar;%APP_HOME%\lib\client.diff-2.1.0-SNAPSHOT.jar;%APP_HOME%\lib\gen.antlr-2.1.0-SNAPSHOT.jar;%APP_HOME%\lib\gen.antlr-antlr-2.1.0-SNAPSHOT.jar;%APP_HOME%\lib\gen.antlr-css-2.1.0-SNAPSHOT.jar;%APP_HOME%\lib\gen.antlr-json-2.1.0-SNAPSHOT.jar;%APP_HOME%\lib\gen.antlr-php-2.1.0-SNAPSHOT.jar;%APP_HOME%\lib\gen.antlr-r-2.1.0-SNAPSHOT.jar;%APP_HOME%\lib\gen.antlr-xml-2.1.0-SNAPSHOT.jar;%APP_HOME%\lib\gen.c-2.1.0-SNAPSHOT.jar;%APP_HOME%\lib\gen.jdt-2.1.0-SNAPSHOT.jar;%APP_HOME%\lib\gen.js-2.1.0-SNAPSHOT.jar;%APP_HOME%\lib\gen.ruby-2.1.0-SNAPSHOT.jar;%APP_HOME%\lib\simmetrics-core-3.2.3.jar;%APP_HOME%\lib\trove4j-3.0.3.jar;%APP_HOME%\lib\gson-2.4.jar;%APP_HOME%\lib\org.eclipse.jdt.core-3.11.0.v20150602-1242.jar;%APP_HOME%\lib\runtime-3.10.0-v20140318-2214.jar;%APP_HOME%\lib\org.eclipse.core.resources-3.10.0.v20150423-0755.jar;%APP_HOME%\lib\reflections-0.9.10.jar;%APP_HOME%\lib\nanohttpd-webserver-2.1.1.jar;%APP_HOME%\lib\rendersnake-1.9.0.jar;%APP_HOME%\lib\antlr-3.5.2.jar;%APP_HOME%\lib\rhino-1.7.7.jar;%APP_HOME%\lib\jrubyparser-0.5.3.jar;%APP_HOME%\lib\guava-18.0.jar;%APP_HOME%\lib\commons-codec-1.10.jar;%APP_HOME%\lib\osgi-3.10.0-v20140606-1445.jar;%APP_HOME%\lib\common-3.6.200-v20130402-1505.jar;%APP_HOME%\lib\jobs-3.6.0-v20140424-0053.jar;%APP_HOME%\lib\registry-3.5.400-v20140428-1507.jar;%APP_HOME%\lib\preferences-3.5.200-v20140224-1527.jar;%APP_HOME%\lib\contenttype-3.4.200-v20140207-1251.jar;%APP_HOME%\lib\app-1.3.200-v20130910-1609.jar;%APP_HOME%\lib\javassist-3.18.2-GA.jar;%APP_HOME%\lib\annotations-2.0.1.jar;%APP_HOME%\lib\nanohttpd-2.1.1.jar;%APP_HOME%\lib\junit-4.8.2.jar;%APP_HOME%\lib\servlet-api-2.4.jar;%APP_HOME%\lib\commons-lang3-3.1.jar;%APP_HOME%\lib\commons-io-2.0.1.jar;%APP_HOME%\lib\spring-webmvc-4.1.6.RELEASE.jar;%APP_HOME%\lib\jtidy-r938.jar;%APP_HOME%\lib\guice-3.0.jar;%APP_HOME%\lib\javax.inject-1.jar;%APP_HOME%\lib\antlr-runtime-3.5.2.jar;%APP_HOME%\lib\ST4-4.0.8.jar;%APP_HOME%\lib\spring-beans-4.1.6.RELEASE.jar;%APP_HOME%\lib\spring-context-4.1.6.RELEASE.jar;%APP_HOME%\lib\spring-core-4.1.6.RELEASE.jar;%APP_HOME%\lib\spring-expression-4.1.6.RELEASE.jar;%APP_HOME%\lib\spring-web-4.1.6.RELEASE.jar;%APP_HOME%\lib\aopalliance-1.0.jar;%APP_HOME%\lib\cglib-2.2.1-v20090111.jar;%APP_HOME%\lib\spring-aop-4.1.6.RELEASE.jar;%APP_HOME%\lib\commons-logging-1.2.jar;%APP_HOME%\lib\asm-3.1.jar
